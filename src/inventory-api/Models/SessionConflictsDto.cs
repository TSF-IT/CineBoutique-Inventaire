...
public sealed class SessionConflictItemDto
{
    ...
    public IReadOnlyList<SessionConflictObservationDto> Observations { get; set; } = Array.Empty<SessionConflictObservationDto>();
...
public sealed class SessionConflictsResponseDto
{
    ...
    public IReadOnlyList<SessionConflictItemDto> Items { get; set; } = Array.Empty<SessionConflictItemDto>();
}
...
public sealed class SessionResolvedConflictsResponseDto
{
    ...
    public IReadOnlyList<SessionResolvedConflictDto> Items { get; set; } = Array.Empty<SessionResolvedConflictDto>();
}

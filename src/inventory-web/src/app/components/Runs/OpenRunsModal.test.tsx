  ...
  it('classe les comptages par libellé de zone et masque le code dans le titre', () => {
    const runs: OpenRunSummary[] = [
      ...
      buildRun({
        ...
        startedAtUtc: '2024-01-01T09:00:00Z',
        countType: 3,
      }),
    ]

    render(<OpenRunsModal open openRuns={runs} onClose={() => {}} />)

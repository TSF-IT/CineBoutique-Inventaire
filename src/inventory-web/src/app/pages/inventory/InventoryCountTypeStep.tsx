  ...
  return (
    <div className="flex flex-col gap-6">
      <Card className="flex flex-col gap-4">
        <h2 className="text-2xl font-semibold text-white">Quel type de comptage ?</h2>
              ...
              <button
                ...
                className={`flex flex-col gap-2 rounded-3xl border px-6 py-6 text-left transition-all ${
                  isSelected
                    ...
                    : 'border-slate-700 bg-slate-900/40 text-slate-200 hover:border-brand-400/50'
                }`}
              >
                <span className="text-4xl font-bold">{option} comptage{option > 1 ? 's' : ''}</span>
